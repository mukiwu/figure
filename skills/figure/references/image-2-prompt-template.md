...
Label style: 中文標註風格：字形輕微傾斜，筆畫帶速度感，線條有自然抖動和停頓，結構鬆動但清晰，整體像情緒很滿時寫下的一句手寫標題。
...
- Include the child-height cute compact rabbit body rule.
- Include the character consistency lock with the fixed child-height head/torso proportion range.
